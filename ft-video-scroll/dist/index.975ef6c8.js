...
var _videoScrollJs = require("./video-scroll.js");
var _fullpageScrollJs = require("./fullpage-scroll.js");
document.addEventListener("DOMContentLoaded", async ()=>{
    try {
        console.log("Initializing application");
        const videoScroll = new (0, _videoScrollJs.VideoScroll)({
            srcDesktop: new URL(require("61a0478a32861017")).href,
            srcMobile: new URL(require("61a0478a32861017")).href,
            fps: 25
        });
        const fullpageScroll = new (0, _fullpageScrollJs.FullpageScroll)();
...
},{"./video-scroll.js":"jrrzH","./fullpage-scroll.js":"k4FPz","61a0478a32861017":"3JgA7"}],"jrrzH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "VideoScroll", ()=>VideoScroll);
class VideoScroll {
    constructor(options){
        this.options = {
        ...
        this.positions = Array.from(this.sections).map((section)=>({
                ...
                transition: {
                    ...
                    backward: this.convertTimeRange([
                        section.dataset.transitionstartbackward || section.dataset.transitionstart || "00:00:00",
                        section.dataset.transitionendbackward || section.dataset.transitionend || "00:00:00"
                    ])
                }
            }));
    ...
    setupEventListeners() {
        ...
        document.addEventListener("nextPlayIndex", (event)=>this.handleSectionChange(event.detail.nextPlayIndex, event.detail.direction));
    }
    setContainerWidth() {
        console.log("Setting container width");
        const viewWidth = window.innerWidth;
        if (viewWidth < this.options.breakpoint && !document.body.classList.contains("mobile")) {
            document.body.classList.remove("desktop");
            document.body.classList.add("mobile");
            this.isMobile = true;
            this.loadVideoAsBlob();
        } else if (viewWidth >= this.options.breakpoint && !document.body.classList.contains("desktop")) {
    ...
    async startVideo() {
        ...
        try {
            ...
            this.loaderWrapper.querySelector(".loader-number").textContent = "Tap to Start";
    ...
    handleSectionChange(index, direction) {
        console.log(`Handling section change to index ${index}, direction: ${direction}`);
    ...
    setVideoToSection(index, direction) {
        ...
        if (this.currentSection) {
            const transitionTime = direction === "forward" ? this.currentSection.transition.forward[0] : this.currentSection.transition.backward[1];
    ...
    updateVideoTime(deltaTime) {
        ...
        let targetTime;
        const transitionDuration = this.direction === "forward" ? this.currentSection.transition.forward[1] - this.currentSection.transition.forward[0] : this.currentSection.transition.backward[1] - this.currentSection.transition.backward[0];
        if (this.isTransitioning) {
            this.transitionProgress += deltaTime;
            const progress = Math.min(this.transitionProgress / transitionDuration, 1);
            if (this.direction === "forward") targetTime = this.lerp(this.currentSection.transition.forward[0], this.currentSection.transition.forward[1], progress);
            else targetTime = this.lerp(this.currentSection.transition.backward[1], this.currentSection.transition.backward[0], progress);
            if (progress >= 1) {
                this.isTransitioning = false;
                this.isScrollAllowed = true;
                targetTime = this.direction === "forward" ? this.currentSection.loop[0] : this.currentSection.loop[1];
            }
        } else {
            const loopDuration = this.currentSection.loop[1] - this.currentSection.loop[0];
            let loopProgress;
            if (this.direction === "forward") {
                loopProgress = (this.video.currentTime - this.currentSection.loop[0] + deltaTime) / loopDuration;
                targetTime = this.lerp(this.currentSection.loop[0], this.currentSection.loop[1], loopProgress % 1);
            } else {
                loopProgress = (this.currentSection.loop[1] - this.video.currentTime + deltaTime) / loopDuration;
                targetTime = this.lerp(this.currentSection.loop[1], this.currentSection.loop[0], loopProgress % 1);
            }
        }
    ...
    convertTime(time) {
        const [min, sec, frames] = time ? time.split(":") : [
            "00",
            "00",
            "00"
        ];
        return Math.max(parseInt(min) * 60 + parseInt(sec) + parseInt(frames) * (1 / 30), 0.01);
    }
    convertTimeRange(timeRange) {
        return [
            this.convertTime(timeRange[0]),
            this.convertTime(timeRange[1])
        ];
    }
}
...
},{}],"k4FPz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FullpageScroll", ()=>FullpageScroll);
var _fullpageJs = require("fullpage.js");
var _fullpageJsDefault = parcelHelpers.interopDefault(_fullpageJs);
class FullpageScroll {
    ...
    init() {
        this.fullpage = new (0, _fullpageJsDefault.default)("#fullpage", {
            ...this.options,
            onLeave: (origin, destination, direction)=>{
                if (this.videoScroll && !this.videoScroll.isScrollAllowed) return false;
                console.log(`Leaving section ${origin.index + 1}, going to ${destination.index + 1}, direction: ${direction}`);
    ...
    handleSectionChange(index, direction) {
        console.log(`FullpageScroll: Changing to section ${index}, direction: ${direction}`);
...
},{"fullpage.js":"3WWpE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3WWpE":[function(require,module,exports) {
/*!
* fullPage 4.0.25
...
*/ (function(global, factory) {
    ...
    */ function styleSection(section) {
        ...
        if (!startingSection && section.isVisible) startingSection = getState().activeSection.item;
    ...
    */ function getActiveSection() {
    ...
    var scrollOverflowHandler = {
        ...
        isScrolled: function isScrolled(direction, el) {
            ...
            if (!isScrolled && direction !== "none") this.timeBeforeReachingLimit = new Date().getTime();
            return isScrolled;
        },
    ...
    */ function hashChangeHandler() {
    ...
    function onClickOrTouch$1(params) {
        var target = params.target;
        if (closest(target, getOptions().menu + " [data-menuanchor]")) menuItemsHandler.call(target, params.e);
    ...
    */ function getActiveSlide() {
    ...
    !function() {
        ...
        var n = "2024-5-22".split("-"), e = new Date(n[0], n[1], n[2]), r = [
            "se",
            "licen",
            "-",
            "v3",
...
},{}],"3JgA7":[function(require,module,exports) {
module.exports = require("c87385fb8b45f78a").getBundleURL("bLxZJ") + "ecfb9e00-feb9-4ee4-911e-a70ce8c32111.ab2a8f43.mp4" + "?" + Date.now();

},{"c87385fb8b45f78a":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire6362")
